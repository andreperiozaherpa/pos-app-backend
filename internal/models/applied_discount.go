...
type AppliedItemDiscount struct {
	TransactionItemID           uuid.UUID `db:"transaction_item_id"`
	DiscountID                  uuid.UUID `db:"discount_id"`
	AppliedDiscountAmountOnItem float64   `db:"applied_discount_amount_on_item"`
}
...
type AppliedTransactionDiscount struct {
	...
	DiscountID                         uuid.UUID `db:"discount_id"`
	AppliedDiscountAmountOnTransaction float64   `db:"applied_discount_amount_on_transaction"`
}
